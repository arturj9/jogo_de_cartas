...
public class TelaJogadorComum extends JFrame {
	...
	private JPanel configurarPainelCentro() {
		...
		JLabel texto = new JLabel("<html>Vez do/a " + rodada.getJogadorDaVez().getNome() + " - DICA: " + dica + "<html>");
		...
		if(intAux >= 5) {
			texto2.setText("<html>Escolha a Carta que você acha que é a do " + rodada.getJogadorDaVez().getNome() + ":<html>");
		} else {
	...
	private class Avancar implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			if(selecionado) {
				...
				JOptionPane.showMessageDialog(janela,"Escolha uma carta antes de apertar no botão 'PRONTO'!", "Erro!", JOptionPane.ERROR_MESSAGE, null);
			}
